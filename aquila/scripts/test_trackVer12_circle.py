...
def load_trained_policy(checkpoint_path):
    ...
    if isinstance(data, dict):
        ...
        action_repeat = data.get('action_repeat', 2)  # Ver12: 50Hz (action_repeat=2)
        buffer_size = data.get('action_obs_buffer_size', 50)  # Ver12: buffer_size=50
        ...
        params = data
        env_config = {}
        action_repeat = 2  # Ver12: 50Hz (action_repeat=2)
        buffer_size = 50  # Ver12: buffer_size=50
        final_loss = 'Unknown'
...
def test_policy():
    ...
    print(f"\n{'='*60}")
    print(f"Testing TrackVer12 Policy")
    print(f"{'='*60}")
    ...
    output_file = 'aquila/output/test_trackVer12_data.pkl'
    ...
    ax1.set_title('TrackVer12: Drone Tracking Trajectory (3D)', fontsize=14, fontweight='bold')
    ax1.legend()
    ...
    plt.tight_layout()
    trajectory_file = 'aquila/output/trackVer12_trajectory_3d.png'
    ...
    plt.tight_layout()
    analysis_file = 'aquila/output/trackVer12_data_analysis.png'
