...
def test_policy():
    ...
    for step in range(max_steps):
        ...
        actions_thrust.append(float(info['action'][0]))
        actions_omega.append(np.array(info['action'][1:]))
    ...
    axes[0, 0].set_title('Thrust Command over Time')
    ...
    axes[0, 1].set_title('Angular Velocity Commands over Time')
    axes[0, 1].legend()
